...
namespace Boyner.Product.Domain.SharedKernel.Utils
{
    /// <summary>
    ...
    public static class Check
    {
        ...
        public static string NotNullOrEmpty(string text, string parameterName)
        {
            ...
            {
                e = new DomainException(ArgumentIsNull, new ArgumentNullException(parameterName));
            }
            else if (text.Trim().Length == 0)
            {
                e = new DomainException(ArgumentIsEmpty, new ArgumentException(ArgumentIsEmpty, parameterName));
            }
        ...
        public static T NotNull<T>(T reference, string parameterName)
        {
            if (ReferenceEquals(reference, null))
            {
                ...
                throw new DomainException(ArgumentIsNull, new ArgumentNullException(parameterName));
            }
        ...
        public static ICollection<T> NotEmpty<T>(ICollection<T> collection, string parameterName)
        {
            ...
            if (collection.Count == 0)
            {
                ...
                throw new DomainException(CollectionArgumentIsEmpty, new ArgumentException(CollectionArgumentIsEmpty, parameterName));
            }
        ...
        public static IEnumerable<T> HasNoNulls<T>(IEnumerable<T> enumerable, string parameterName) where T : class
        {
            ...
            if (enumerable.Any(e => e == null))
            {
                ...
                throw new DomainException(CollectionArgumentHasNullElement, new ArgumentException(CollectionArgumentHasNullElement, parameterName));
            }
        ...
        public static string FileExists(string filePath, string parameterName)
        {
            ...
            if (!File.Exists(filePath))
            {
                ...
                throw new DomainException(FileNotFound, new ArgumentException(FileNotFound, parameterName, new FileNotFoundException(FileNotFound, filePath)));
            }
        ...
        public static string DirectoryExists(string path, string parameterName)
        {
            ...
            if (!Directory.Exists(path))
            {
                ...
                throw new DomainException(string.Format(DirectoryNotFound, path), new ArgumentException(string.Format(DirectoryNotFound, path), parameterName, new DirectoryNotFoundException(path)));
            }
        ...
        public static T Positive<T>(T value, string parameterName) where T : struct, IComparable, IComparable<T>, IConvertible, IEquatable<T>, IFormattable
        {
            ...
            if (compare <= 0)
            {
                ...
                throw new DomainException(NumberNotPositive, new ArgumentOutOfRangeException(parameterName, value, NumberNotPositive));
            }
        ...
        public static T HasValue<T>(T value, string parameterName) where T : struct, IComparable, IComparable<T>, IEquatable<T>, IFormattable
        {
            ...
            if (compare == 0)
            {
                ...
                throw new DomainException(ArgumentIsDefault, new ArgumentException(ArgumentIsDefault, parameterName));
            }
